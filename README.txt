...
В v6.33 исправлена передача контакта покупателя в Dreamkas.
...
В v6.33 исправлена ошибка, когда при выборе “Общая система налогообложения — ОСН” в Dreamkas отправлялся код:
...
В v6.33 добавлена отмена на этапе заполнения реквизитов нового чека.

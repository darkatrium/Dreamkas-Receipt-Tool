...
echo ==========================================
echo        Dreamkas Receipt Tool v6.32
echo ==========================================
echo.
...
if "%EXCEL_FILE%"=="" if exist "dreamkas_receipt_template.xlsx" set "EXCEL_FILE=dreamkas_receipt_template.xlsx"
if "%EXCEL_FILE%"=="" set "EXCEL_FILE=dreamkas_receipt_template.xlsx"
...
echo If Python installation failed, run this BAT as Administrator.
pause
exit /b 1

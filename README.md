...
В v6.32 исправлена ошибка, когда при выборе “Общая система налогообложения — ОСН” в Dreamkas отправлялся код:
...
В v6.32 добавлена отмена на этапе заполнения реквизитов нового чека.
